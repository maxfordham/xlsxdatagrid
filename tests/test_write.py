...
def test_from_pydantic_object(is_transposed: bool, exclude_metadata: bool, exclude_header_lines: bool):
    data = [
        {
            'a_constrainedint': 3,
            'a_int': 1,
    ...
    fpth = dest_dir / f"test_from_pydantic_object-{is_transposed}-{exclude_metadata}-{exclude_header_lines}.xlsx"
